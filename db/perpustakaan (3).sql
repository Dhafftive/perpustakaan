...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 02 Mar 2024 pada 11.07
...
(32, 2, 'Justina Xie Album (Limited Edition)', 'Justina Xie ', 'Douyin Official', 2023, 6, 'a69f9cc7-1b6b-484f-b910-d0b2f7071fab.jpg', 'This is limited edition! Get your official album from Justina Xie in albumdouyinsofficial.com', '', 1, '2024-03-01 10:26:25'),
(33, 2, 'My Hero Academia Vol. 13', 'Kohei Horikoshi', 'Shueisha', 2017, 7, 'My Hero Academia Vol_ 13 By_ Kohei Horikoshi….jpeg', 'Dalam volume ke-13 dari seri My Hero Academia, cerita terus mengikuti perjalanan Midoriya Izuku dan teman-temannya di sekolah Yuei yang bergengsi. Di tengah-tengah pelatihan mereka yang semakin intensif, mereka dihadapkan pada berbagai ujian dan tantangan yang menantang. Volume ini memperlihatkan perkembangan karakter-karakter utama, termasuk Midoriya, Bakugo, dan Todoroki, dalam mengejar impian mereka untuk menjadi pahlawan super yang hebat. Selain itu, konflik-konflik baru pun muncul, termasuk kemunculan musuh-musuh baru yang menantang. Dengan ilustrasi yang memukau dan plot yang menegangkan, volume ke-13 My Hero Academia akan membawa pembaca pada petualangan yang mendebarkan di dunia pahlawan super yang penuh warna dan semangat.', 'My Hero Academia, Vol. 13 A Talk About Your Quirk (Horikoshi, Kohei) (Z-Library)-dikompresi.pdf', 1, '2024-03-01 14:12:34');
...
(139, 'User bernama didaarfiana telah login', '2024-03-01 02:09:03'),
(140, 'User bernama nanasmadu telah login', '2024-03-01 02:23:14'),
(141, 'User bernama didaarfiana telah login', '2024-03-01 02:24:23'),
(142, 'User bernama nanasmadu telah login', '2024-03-01 02:46:27'),
(143, 'User bernama albia berhasil registrasi ke database', '2024-03-01 02:56:54'),
(144, 'User bernama albia telah login', '2024-03-01 02:57:02'),
(145, 'User bernama didaarfiana telah login', '2024-03-01 02:58:37'),
(146, 'User bernama nanasmadu telah login', '2024-03-01 02:59:15'),
(147, 'User bernama didaarfiana telah login', '2024-03-01 02:59:35'),
(148, 'User bernama nanasmadu telah login', '2024-03-01 03:00:32'),
(149, 'User bernama didaarfiana telah login', '2024-03-01 03:00:47'),
(150, 'User bernama nanasmadu telah login', '2024-03-01 07:57:58'),
(151, 'User bernama didaarfiana telah login', '2024-03-01 10:07:43'),
(152, 'User bernama nanasmadu telah login', '2024-03-01 10:26:18'),
(153, 'User nanasmadu telah menambahkan buku berjudul My Hero Academia Vol. 13', '2024-03-01 14:09:16'),
(154, 'User nanasmadu telah logout karena sesi berakhir', '2024-03-02 00:48:26'),
(155, 'User nanasmadu telah logout karena sesi berakhir', '2024-03-02 00:48:28'),
(156, 'User bernama didaarfiana telah login', '2024-03-02 00:49:05'),
(157, 'User bernama nanasmadu telah login', '2024-03-02 00:50:46'),
(158, 'User bernama didaarfiana telah login', '2024-03-02 09:23:23');
...
(48, 55, 32, '2024-03-01 02:55:24'),
(49, 61, 32, '2024-03-01 02:57:37'),
(50, 16, 32, '2024-03-01 03:00:10'),
(51, 55, 33, '2024-03-01 14:12:26');
...
(68, 2, 16, 5, '2024-02-29', '2024-03-01', 'dikembalikan', '2024-03-01 10:26:02'),
(69, 2, 16, 3, '2024-02-29', '2024-03-01', 'dikembalikan', '2024-02-29 17:24:58'),
(70, 2, 16, 7, '2024-02-29', '2024-03-01', 'dikembalikan', '2024-03-01 10:25:58'),
(71, 2, 16, 32, '2024-02-29', '2024-03-01', 'dikembalikan', '2024-02-29 17:46:05'),
(72, 2, 55, 3, '2024-03-01', '2024-03-01', 'dikembalikan', '2024-03-01 10:26:28'),
(73, 2, 55, 32, '2024-03-01', '2024-03-01', 'dikembalikan', '2024-03-01 10:26:25'),
(74, 2, 55, 33, '2024-03-01', '0000-00-00', 'dipinjam', '2024-03-01 14:12:34');
...
(18, 21, 55, 21, 'Sebagian tutornya kurang efektif dan kurang up to date', 2, '2024-03-01 08:02:30');
...
(60, 2, 'dafa', '$2y$10$1/okF2HSQBI4LSncXjRfaOJK6lbpgNYk2do5yzJfHb8uFVf7xiD7C', 'dafayanuar@gmail.com', 'Nanas Muda', '08967745465', 'Jln Sinartanjung No. 37', 'petugas', '2024-03-01 13:02:49'),
(61, 2, 'albia', '$2y$10$fVa.tRjngmH3AYhEL9mhweiuPHLgH3JU3h7eB6QEnacGnU53d8ba.', 'didaarfiana05@gmail.com', 'Albia Fabiansyah', '0897665574322', 'jalan citangkolo', 'peminjam', '2024-03-01 02:56:53');
...
--
ALTER TABLE `c_logs`
  MODIFY `logsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
...
--
ALTER TABLE `koleksipribadi`
  MODIFY `koleksiID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT untuk tabel `peminjaman`
--
ALTER TABLE `peminjaman`
  MODIFY `peminjamanID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;
